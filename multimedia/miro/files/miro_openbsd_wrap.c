...
/*-----------------------------------------------
              @(target):= _miro_openbsd.so
  ------------------------------------------------*/
#define SWIG_init    init_miro_openbsd

#define SWIG_name    "_miro_openbsd"
...
extern "C" {
#endif
static PyObject *_wrap_maxname(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    int result;
    
    if(!PyArg_ParseTuple(args,(char *)":maxname")) goto fail;
    result = (int)maxname();
...
static PyObject *_wrap_availbytes(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    char *arg1 = (char *) 0 ;
    int result;
    PyObject * obj0 = 0 ;
    
    if(!PyArg_ParseTuple(args,(char *)"O:availbytes",&obj0)) goto fail;
    if (!SWIG_AsCharPtr(obj0, (char**)&arg1)) {
        SWIG_arg_fail(1);SWIG_fail;
    }
    result = (int)availbytes(arg1);
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"maxname", _wrap_maxname, METH_VARARGS, NULL},
	 { (char *)"availbytes", _wrap_availbytes, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
