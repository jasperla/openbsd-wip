...
#  BACKTRACE_INCLUDES     - list of header filess needed for backtrace(3)
#  BACKTRACE_INCLUDE_DIRS - where to find ${BACKTRACE_INCLUDES}
...
find_path(BACKTRACE_INCLUDE_DIR "execinfo.h")
...
if(_BACKTRACE_SYM_FOUND)
	set(BACKTRACE_INCLUDES "execinfo.h")
	...
	if(BACKTRACE_INCLUDE_DIR)
		...
		set(BACKTRACE_INCLUDES "backtrace.h")
...
mark_as_advanced(BACKTRACE_INCLUDE_DIR BACKTRACE_LIBRARIES)
